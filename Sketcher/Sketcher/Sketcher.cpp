...
CSketcherApp::CSketcherApp()
{
	...
	//MessageBox( NULL , TEXT("CSketcherApp类构造") , NULL , MB_OK);
}

// 唯一的一个 CSketcherApp 对象
//int a=MessageBox( NULL , TEXT("CSketcherApp类创建前") , NULL , MB_OK);
CSketcherApp theApp;
...
{
	//MessageBox( NULL , TEXT("初始化代码") , NULL , MB_OK);
...
{
	MessageBox( NULL , TEXT("CAboutDlg类构造") , NULL);
}
